...
public interface Factory {
  ...
  /**
   * Create a new app:edited element.  The app:edited element is defined by the 
   * Atom Publishing Protocol specification for use in atom:entry elements created 
   * and edited using that protocol.  The element should only ever appear as a 
   * child of atom:entry.
   ...
   * 
   * RFC4287 provides the abstract Atom Date Construct as a reusable component. 
   * Any extension element whose value is a Date/Time SHOULD reuse this construct
   * to maintain consistency with the base specification.
   * 
   ...
   * 
   * RFC4287 provides the abstract Atom Person Construct to represent people and
   * other entities within an Atom Document.  Extensions that wish to represent
   * people SHOULD reuse this construct.
   * 
   ...
   * 
   * RFC4287 provides the abstract Text Construct to represent simple Text, HTML
   * or XHTML within a document.  This construct is used by Atom core elements
   * like atom:title, atom:summary, atom:rights, atom:subtitle, etc and SHOULD
   * be reused by extensions that need a way of embedding text in a document.
   * 
   ...
   * the Atom Publishing Protocol as a means of allowing publishing clients to
   * provide metadata to a server affecting the way an entry is published.  The
   * control element SHOULD only ever appear as a child of the atom:entry and 
   * MUST only ever appear once.
   ...
   * by the Atom Publishing Protocol as a means of providing a listing of 
   * atom:category's that can be used by entries in a collection.
