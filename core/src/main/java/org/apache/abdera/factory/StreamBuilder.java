 ...
 * can be used to create Feed Object Model instances using the StreamWriter 
 * interface.  StreamBuilder provides an additional method (getBase) for returning
 * the FOM Base element that was built.
 * 
 * The StreamWriter methods indent(), flush(), close(), setWriter(), setInputStream, 
 * setAutoclose(), setAutoflush(), setAutoIndent(), and setChannel() have no effect
 * on this StreamWriter implementation 
 * 
 * <pre>
 *  StreamBuilder sw = new StreamBuilder(); 
 *  Entry entry = 
 *    sw.startElement(Constants.ENTRY)
...
public class StreamBuilder 
  ...
  public StreamBuilder writeAttribute(
    String name, 
    String namespace,
    String prefix, 
    String value) {
  ...
  public StreamBuilder writePI(String value, String target) {
    if (!(current instanceof Document)) throw new IllegalStateException("Not currently a document");
  ...
  public StreamBuilder startText(String name, String namespace,
      String prefix, org.apache.abdera.model.Text.Type type) {
  ...
  public StreamBuilder writeAttribute(String name, String namespace,
      Date value) {
  ...
  public StreamBuilder writeAuthor(String name, String email,
      String uri) {
  ...
  public StreamBuilder writeContent(Type type, DataHandler value)
      throws IOException {
    return (StreamBuilder)super.writeContent(type, value);
  }

  public StreamBuilder writeContent(Type type, InputStream value)
      throws IOException {
    return (StreamBuilder)super.writeContent(type, value);
  }
  ...
  public StreamBuilder writeContributor(String name, String email,
      String uri) {
  ...
  public StreamBuilder writeDate(String name, String namespace,
      Date date) {
  ...
  public StreamBuilder writeElementText(DataHandler value)
      throws IOException {
  ...
  public StreamBuilder writeGenerator(String version, String uri,
      String value) {
  ...
  public StreamBuilder writeIRIElement(String name, String namespace,
      IRI iri) {
    return (StreamBuilder)super.writeIRIElement(name, namespace, iri);
  }

  public StreamBuilder writeIRIElement(String name, String namespace,
      String prefix, IRI iri) {
  ...
  public StreamBuilder writePerson(QName qname, String name,
      String email, String uri) {
    return (StreamBuilder)super.writePerson(qname, name, email, uri);
  }

  public StreamBuilder writePerson(String localname, String namespace,
      String prefix, String name, String email, String uri) {
    return (StreamBuilder)super.writePerson(localname, namespace, prefix, name, email, uri);
  }

  public StreamBuilder writePerson(String localname, String namespace,
      String name, String email, String uri) {
    return (StreamBuilder)super.writePerson(localname, namespace, name, email, uri);
  }

  public StreamBuilder writePerson(String localname, String name,
      String email, String uri) {
  ...
  public StreamBuilder writeRights(
      org.apache.abdera.model.Text.Type type, String value) {
  ...
  public StreamBuilder writeSubtitle(
      org.apache.abdera.model.Text.Type type, String value) {
  ...
  public StreamBuilder writeSummary(
      org.apache.abdera.model.Text.Type type, String value) {
  ...
  public StreamBuilder writeText(String name, String namespace,
      String prefix, org.apache.abdera.model.Text.Type type, String value) {
  ...
  public StreamBuilder writeTitle(
      org.apache.abdera.model.Text.Type type, String value) {
