...
public final class Lang
  ...
  private Locale initLocale() {
    ...
    else return new Locale(primary.toString());
  }
  ...
  /**
   * Get the beginning of the private-use section.  This will return the
   * x prefix subtag
   */
  ...
  public Lang getParent() {
    ...
    for (Subtag tag : lang)
      last = tag;
    if (last.getPrevious() == null) return null;
